...
class ModeradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moderador" do
    assert_difference('Moderador.count') do
      post moderadors_url, params: { moderador: { email: @moderador.email, nome: @moderador.nome, sal: @moderador.sal, senha: @moderador.senha } }
    end
  ...
  test "should update moderador" do
    patch moderador_url(@moderador), params: { moderador: { email: @moderador.email, nome: @moderador.nome, sal: @moderador.sal, senha: @moderador.senha } }
